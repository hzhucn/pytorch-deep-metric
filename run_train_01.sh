#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=6 python train.py -data car  -net bn  -alpha 40 -k 100  -lr 1e-5 -dim 512   -num_instances 8 -BatchSize 128  -loss branchKS  -epochs 1201 -log_dir branchKS  -save_step 50
...
CUDA_VISIBLE_DEVICES=6 python train.py -data car  -net bn -orth 1e-1 -alpha 40 -k 100  -lr 1e-5 -dim 512   -num_instances 8 -BatchSize 128  -loss branchKS  -epochs 1201 -log_dir branchKS  -save_step 50
...
CUDA_VISIBLE_DEVICES=6 python train.py -data car  -net bn -orth 1e-2 -alpha 40 -k 100  -lr 1e-5 -dim 512   -num_instances 8 -BatchSize 128  -loss branchKS  -epochs 1201 -log_dir branchKS  -save_step 50
