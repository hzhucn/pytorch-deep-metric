...
CUDA_VISIBLE_DEVICES=5 python train.py -data car  -net bn -orth 1e-3 -alpha 40 -k 100  -lr 1e-5 -dim 512   -num_instances 8 -BatchSize 128  -loss branchKS  -epochs 601 -log_dir branchKS_orth -save_step 50
...
CUDA_VISIBLE_DEVICES=5 python train.py -data car  -net bn -orth 1e-4 -alpha 40 -k 100  -lr 1e-5 -dim 512   -num_instances 8 -BatchSize 128  -loss branchKS  -epochs 601 -log_dir branchKS_orth -save_step 50
...
CUDA_VISIBLE_DEVICES=5 python train.py -data car  -net bn -orth 1e-5 -alpha 40 -k 100  -lr 1e-5 -dim 512   -num_instances 8 -BatchSize 128  -loss branchKS  -epochs 601 -log_dir branchKS_orth -save_step 50
